...
- “工程化分发与升级”是框架可落地的前提：gstack 提供 team mode + 自动更新节流；BMAD 提供安装器与 non-interactive 安装；OpenSpec 提供 `openspec update` 刷新指令；Spec Kit 鼓励 pin release tag。（Ref: ../reference_src/04-framework-gstack-github-readme.md；../reference_src/04-framework-bmad-method-github-readme.md；../reference_src/04-framework-openspec-github-readme.md；../reference_src/04-framework-spec-kit-github-readme.md）
