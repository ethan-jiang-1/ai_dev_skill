...
- last_updated: 2026-04-09 14:05:03 +0800
...
- [x] >= 8 份共享型 ground truth（当前：`reference_cap` 已落库 60 条参考文档；详见 `reference_cap/_INDEX.md`）
...
- [x] ground truth docs（>=8）：已落库 22 条（以 `reference_cap/03-*.md` 为主）
...
- [x] ground truth docs（>=8）：已落库 14 条（以 `reference_cap/04-*.md` 为主）
