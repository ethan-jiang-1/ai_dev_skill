...
### Quickstart：先用一个 writing skill 把 Layer 1-3 走通

如果你不想先做完 host 对比，最稳的上手方式是：先选一个“主要封装方法论”的 writing skill 跑通一次。它能让你立刻体感：
...
你跑完这三步，再回头读第 3-4 章，会更容易看懂“runtime contract”到底在指什么。
...
**第一步：单 Host 熟练**
- 选一个 host，装几个 writing skills，跑起来（第 2 章末尾有 `Quickstart` 三步模板）
