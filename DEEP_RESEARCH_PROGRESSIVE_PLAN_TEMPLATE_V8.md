...
| `topic stop decision` | `PLAN_PATH -> 搜够了没有：停止条件` | `<STATUS_PATH>.Wave 1` + `Suspended Branches` | `not_assessed / continue / early_saturation / suspend / archive / redirect` 都属于 topic-level decision |
